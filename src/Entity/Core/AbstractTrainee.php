...
#[ORM\UniqueConstraint(name: 'emailUnique', columns: ['email'])] abstract class AbstractTrainee implements UserInterface, \Serializable, SerializedAccessRights, \Stringable
{
     ...
     * @var \Doctrine\Common\Collections\Collection<int, \App\Entity\Core\AbstractInscription>|\App\Entity\Core\AbstractInscription[]
     */
    #[ORM\OneToMany(targetEntity: \App\Entity\Core\AbstractInscription::class, mappedBy: 'trainee', cascade: ['remove'])]
    protected ArrayCollection $inscriptions;
