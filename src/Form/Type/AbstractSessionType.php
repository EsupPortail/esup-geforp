...
class AbstractSessionType extends AbstractType
{
    public function buildForm(FormBuilderInterface $builder, array $options): void
    {
        $builder
            ...
            ->add('hournumber', TextType::class, ['label'    => "Nombre d'heures", 'required' => true, 'data' => 1, 'attr'     => ['min' => 1, 'max' => 999]])
            ->add('daynumber', TextType::class, ['label'    => 'Nombre de jours', 'required' => true, 'data' => 1, 'attr'     => ['min' => 1, 'max' => 999]])
