...
final class AdminShibbolethUserToken extends AbstractToken {
    ...
    function getUID(): array {
        return $this->getAttribute('uid');
    }
    
    function getAffiliation(): array {
        return $this->getAttribute('affiliation');
    }
    
    function getScopedAffiliation(): array {
