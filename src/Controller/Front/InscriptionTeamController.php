 ...
 */
class InscriptionTeamController extends AbstractController
{
     ...
     * Registrations.
     *
     * @Route("/registrations", name="front.team.registrations")
     * @Template("Front/Team/registration/registrations.html.twig")
     * @Method("GET")
     */
     ...
     *
     * @Route("/registration/{id}/desist", name="front.team.registration.desist")
     * @Template("Front/Team/registration/registration-desist.html.twig")
     */
     ...
     *
     * @Route("/registration/{id}/authorize", name="front.team.registration.authorize")
     */
    ...
    /**
     * Valid registration
     * @Route("/registration/{id}/valid", name="front.team.registration.valid")
     * @Template("Front/Team/registration/registration-valid.html.twig")
     *
     */
