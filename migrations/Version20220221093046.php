 ...
 */
final class Version20220221093046 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE corps (id INT AUTO_INCREMENT NOT NULL, corps VARCHAR(255) NOT NULL, libelle_court VARCHAR(255) NOT NULL, libelle_long VARCHAR(255) NOT NULL, category VARCHAR(255) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE inscription (id INT AUTO_INCREMENT NOT NULL, trainee_id INT DEFAULT NULL, session_id INT DEFAULT NULL, inscription_status_id INT DEFAULT NULL, presence_status_id INT DEFAULT NULL, actiontype_id INT DEFAULT NULL, type VARCHAR(255) NOT NULL, motivation LONGTEXT DEFAULT NULL, message LONGTEXT DEFAULT NULL, refuse LONGTEXT DEFAULT NULL, dif TINYINT(1) DEFAULT 0, INDEX IDX_5E90F6D636C682D0 (trainee_id), INDEX IDX_5E90F6D6613FECDF (session_id), INDEX IDX_5E90F6D6CDE2C2A5 (inscription_status_id), INDEX IDX_5E90F6D6D079F0B (presence_status_id), INDEX IDX_5E90F6D6FE4F5A7B (actiontype_id), UNIQUE INDEX traineesession_idx (trainee_id, session_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE session (id INT AUTO_INCREMENT NOT NULL, training_id INT DEFAULT NULL, promote TINYINT(1) NOT NULL, dateBegin DATETIME NOT NULL, dateEnd DATETIME DEFAULT NULL, registration INT NOT NULL, status INT NOT NULL, displayOnline TINYINT(1) NOT NULL, numberOfRegistrations INT DEFAULT NULL, maximumNumberOfRegistrations INT NOT NULL, limitRegistrationDate DATETIME NOT NULL, comments LONGTEXT DEFAULT NULL, hourNumber DOUBLE PRECISION NOT NULL, dayNumber DOUBLE PRECISION NOT NULL, schedule VARCHAR(512) DEFAULT NULL, place LONGTEXT DEFAULT NULL, sessionType_id INT DEFAULT NULL, type VARCHAR(255) NOT NULL, name VARCHAR(255) DEFAULT NULL, price DOUBLE PRECISION DEFAULT NULL, teaching_cost DOUBLE PRECISION DEFAULT NULL, vacation_cost DOUBLE PRECISION DEFAULT NULL, accommodation_cost DOUBLE PRECISION DEFAULT NULL, meal_cost DOUBLE PRECISION DEFAULT NULL, transport_cost DOUBLE PRECISION DEFAULT NULL, material_cost DOUBLE PRECISION DEFAULT NULL, taking DOUBLE PRECISION DEFAULT NULL, INDEX IDX_D044D5D4BEFD98D1 (training_id), INDEX IDX_D044D5D49CA958D5 (sessionType_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE supanncodeentite (id INT AUTO_INCREMENT NOT NULL, supannCodeEntite VARCHAR(255) NOT NULL, Description VARCHAR(255) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE evaluation_noted_criterion DROP FOREIGN KEY FK_CF1B085E5DAC5993');
        ...
        $this->addSql('ALTER TABLE file_material DROP FOREIGN KEY FK_CDEEFA08BF396750');
        $this->addSql('ALTER TABLE link_material DROP FOREIGN KEY FK_B114155CBF396750');
        $this->addSql('ALTER TABLE action_type DROP FOREIGN KEY FK_FA3FEC2732C8A3DE');
        $this->addSql('ALTER TABLE evaluation_criterion DROP FOREIGN KEY FK_AE82E9F532C8A3DE');
        ...
        $this->addSql('ALTER TABLE internship__internship_public_type DROP FOREIGN KEY FK_EFCEC7479E92D321');
        $this->addSql('ALTER TABLE internship__internship_public_type_restrict DROP FOREIGN KEY FK_D3D52E5ED0C812B8');
        ...
        $this->addSql('ALTER TABLE alert DROP FOREIGN KEY FK_17FD46C1613FECDF');
        ...
        $this->addSql('ALTER TABLE alert DROP FOREIGN KEY FK_17FD46C136C682D0');
        ...
        $this->addSql('ALTER TABLE internship DROP FOREIGN KEY FK_10D1B00CBF396750');
        ...
        $this->addSql('DROP TABLE supanncodeentite');
