...
function $RouteProvider(){
   ...
   *    Object properties:
   *
   *    - `controllers` – `{(string|function()=}` – Controller fn that should be associated with newly
   *      created scope or the name of a {@link angular.Module#controller registered controllers}
   ...
   *      be injected into the controllers. If any of these dependencies are promises, they will be
   *      resolved and converted to a value before the controllers is instantiated and the
   ...
   *        before its value is injected into the controllers.
   *
